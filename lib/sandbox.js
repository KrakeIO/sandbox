...
SandBox = function(socket_host, socket_options, interface) {
  var self = this;
  self.interface = require('sandbox').interface;
...
SandBox.prototype.getJsonQueryObject = function () {
  ...
  if(data_obj) {
    self.interface.queryHolder().val(self.formatJSON(data_obj));
    return data_obj;    
  } else {
    return false;    
  }
...
SandBox.prototype.filterSchema = function(schema, object) {
  if(object.column_filter) { 
    return schema.filter(function(e){
